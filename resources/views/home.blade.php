...
@section('body')
								...
								<div class="row">
									...
									<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
										<div class="panel panel-default card-view panel-refresh">
											...
											<div class="panel-heading">
												<div class="pull-left">
													<h6 class="panel-title txt-dark">Couriers Split</h6>
												</div>
											...
											<div class="panel-wrapper collapse in">
												<div class="panel-body">
													<div id="e_chart_4" class="" style="height:346px;"></div>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
										<div class="panel panel-default card-view panel-refresh">
											...
											<div class="panel-heading">
												<div class="pull-left">
													<h6 class="panel-title txt-dark">Delivery Performance</h6>
												</div>
												<div class="pull-right">
													<a href="#" class="pull-left inline-block refresh mr-15">
														<i class="zmdi zmdi-replay"></i>
									...
									<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
										<div class="panel panel-default card-view panel-refresh">
											...
											<div class="panel-wrapper collapse in">
												<div class="panel-body">
													<div id="e_chart_5" class="" style="height:346px;"></div>
												</div>
											</div>
										</div>
				...
				<div class="panel-body row">
					...
					<div class="col-sm-6 pr-0 pt-25">
						<div class="label-chatrs">
							<div class="mb-5">
								<span class="clabels inline-block bg-gold mr-5"></span>
								<span class="clabels-text font-12 inline-block txt-dark capitalize-font">Paleo Bars</span>
							</div>
							<div class="">
								<span class="clabels inline-block bg-light-gold mr-5"></span>
	...
	<div class="col-lg-6 col-md-6 col-xs-12">
		<div class="panel panel-default card-view panel-refresh">
			...
			<div class="panel-heading">
				<div class="pull-left">
					<h6 class="panel-title txt-dark">Shipment</h6>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="panel-wrapper collapse in">
		...
		<div class="panel panel-default card-view sm-data-box-3">
			...
			<div class="panel-wrapper collapse in">
				<div class="panel-body">
					<div class="col-sm-6 pa-0">
						<span id="pie_chart_5" class="easypiechart" data-percent="33">
							<span class="percent block txt-dark weight-500"></span>
							<span class="block txt-success text-center">
								<i class="zmdi zmdi-caret-up pr-5 font-20"></i><span class="weight-500">+33%</span>
							</span>
