...
<head>
	...
	<!-- Data table CSS -->
	<link href="{{asset('vendor/vendors/bower_components/datatables/media/css/jquery.dataTables.min.css')}}" rel="stylesheet" type="text/css"/>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="mobile-only-brand pull-left">
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="{{url('/home')}}">
							<img class="brand-img" src="{{asset('vendor/spyder.png')}}" alt="brand"/>
...
<!-- 					<li class="dropdown app-drp">
								...
								<ul class="pa-20">
									...
									<li class="col-md-6 col-xs-12 preview-carousel">
										...
										<div class="product-carousel owl-carousel owl-theme text-center">
											<a href="#">
												<img src="{{asset('vendor/img/chair.jpg')}}" alt="chair">
												<span>Circle chair</span>
											</a>
											<a href="#">
												<img src="{{asset('vendor/img/chair2.jpg')}}" alt="chair">
												<span>square chair</span>
											</a>
											<a href="#">
												<img src="{{asset('vendor/img/chair3.jpg')}}" alt="chair">
												<span>semi circle chair</span>
											</a>
											<a href="#">
												<img src="{{asset('vendor/img/chair4.jpg')}}" alt="chair">
					...
					<li class="dropdown auth-drp">
						<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="{{asset('vendor/img/user1.png')}}" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
						<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
							<li>
								<a href="{{url('vendor-profile')}}"><i class="zmdi zmdi-account"></i><span>Profile</span></a>
							</li>
					<!-- 		<li>
  ...
  @endif				
	...
	<script src="{{asset('vendor/vendors/bower_components/datatables/media/js/jquery.dataTables.min.js')}}"></script>
	<script src="{{asset('vendor/dist/js/dataTables-data.js')}}"></script>
	...
	<script src="{{asset('vendor/vendors/bower_components/echarts/dist/echarts-en.min.js')}}"></script>
	<script src="{{asset('vendor/vendors/echarts-liquidfill.min.js')}}"></script>
	<script src="{{asset('vendor/vendors/ecStat.min.js')}}"></script>

	<script src="{{asset('vendor/vendors/bower_components/waypoints/lib/jquery.waypoints.min.js')}}"></script>
	<script src="{{asset('vendor/vendors/bower_components/jquery.counterup/jquery.counterup.min.js')}}"></script>

	<!-- Owl JavaScript -->
	<script src="{{asset('vendor/vendors/bower_components/owl.carousel/dist/owl.carousel.min.js')}}"></script>
	
	
	<script src="{{asset('vendor/vendors/chart.js/Chart.min.js')}}"></script>

	<script src="{{asset('vendor/vendors/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js')}}"></script>

		<!-- Switchery JavaScript -->
	<script src="{{asset('vendor/vendors/bower_components/switchery/dist/switchery.min.js')}}"></script>
	
	<!-- Fancy Dropdown JS -->
	<script src="{{asset('vendor/dist/js/dropdown-bootstrap-extended.js')}}"></script>
	
	<!-- Init JavaScript -->
	<script src="{{asset('vendor/dist/js/init.js')}}"></script>
	<script src="{{asset('vendor/dist/js/dashboard4-data.js')}}"></script>
